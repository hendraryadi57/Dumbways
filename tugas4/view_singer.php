...
<html>
  ...
  <body>
    ...
    <tbody>
      ...
      $query = "SELECT * FROM singer ORDER BY id_singer ASC";
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="edit_singer.php?id=<?php echo $row['id_singer']; ?>">Edit</a> |
              <a href="proses_hapus_singer.php?id=<?php echo $row['id_singer']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
